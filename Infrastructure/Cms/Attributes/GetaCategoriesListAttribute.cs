...
public class GetaCategoriesListAttribute : Attribute, IDisplayMetadataProvider
{
    ...
    public void CreateDisplayMetadata(DisplayMetadataProviderContext context)
    {
        if (context.DisplayMetadata.AdditionalValues["epi:extendedmetadata"] is ExtendedMetadata extendedMetadata)
        {
            ...
            IContentRepositoryDescriptor contentRepositoryDescriptor = _contentRepositoryDescriptors.First((IContentRepositoryDescriptor x) => x.Key == CategoryContentRepositoryDescriptor.RepositoryKey);
