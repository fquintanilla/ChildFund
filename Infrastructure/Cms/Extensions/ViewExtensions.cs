...
public static class ViewExtensions
{
    ...
    {
        var result = new ContentResult { Content = Serialize(data), ContentType = "text/json" };
        return result;
    }
    ...
    public static bool ValidateProperty(this ContentArea property) =>
        _contextModeResolver.Service.CurrentMode == ContextMode.Edit || IsContentAreaNonEmpty(property);
