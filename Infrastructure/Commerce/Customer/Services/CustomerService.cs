...
namespace ChildFund.Infrastructure.Commerce.Customer.Services
{
    public class CustomerService : ICustomerService
    {
        ...
        public virtual void EditContact(FoundationContact model) => UpdateContact(model.ContactId.ToString(), model.UserRole);
