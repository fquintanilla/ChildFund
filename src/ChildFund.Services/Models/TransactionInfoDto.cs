...
public class TransactionInfoDto
{
    ...
    public string[]? ContactErrorList { get; set; }
    ...
    [JsonPropertyName("<DonorExtraAddress1>k__BackingField")]
    public string? DonorExtraAddress1 { get; set; }

    [JsonPropertyName("<DonorExtraAddress2>k__BackingField")]
    public string? DonorExtraAddress2 { get; set; }

    [JsonPropertyName("<DonorExtraAddress3>k__BackingField")]
    public string? DonorExtraAddress3 { get; set; }
    ...
    [JsonPropertyName("<DonorMarketingId>k__BackingField")]
    public int DonorMarketingId { get; set; }

    [JsonPropertyName("<DonorMotivatedById>k__BackingField")]
    public int DonorMotivatedById { get; set; }

    [JsonPropertyName("<DonorOriginCode>k__BackingField")]
    public string? DonorOriginCode { get; set; }

    [JsonPropertyName("<DonorPhoneAreaCode>k__BackingField")]
    public string? DonorPhoneAreaCode { get; set; }

    [JsonPropertyName("<DonorPhoneExtension>k__BackingField")]
    public int DonorPhoneExtension { get; set; }
    ...
    [JsonPropertyName("<DonorSuffixId>k__BackingField")]
    public int DonorSuffixId { get; set; }

    [JsonPropertyName("<DonorTitleId>k__BackingField")]
    public int DonorTitleId { get; set; }
    ...
    public EnvelopeDto? Errors { get; set; }
    ...
    [JsonPropertyName("<MaskedAccountNum>k__BackingField")]
    public string? MaskedAccountNum { get; set; }

    [JsonPropertyName("<MessageId>k__BackingField")]
    ...
    public string[]? PaymentErrorList { get; set; }
    ...
    [JsonPropertyName("<PurchasedDonations>k__BackingField")]
    public DonationInfoDto[]? PurchasedDonations { get; set; }

    [JsonPropertyName("<QueueID>k__BackingField")]
