...
namespace ChildFund.Web.Features.MyAccount.CreditCard
{
    public class CreditCardService : ICreditCardService
    {
        ...
        public Mediachase.Commerce.Customers.CreditCard GetCreditCard(string creditCardId)
        {
            ...
            return BusinessManager.List(
                ...
                new FilterElement[1] { new FilterElement("CreditCardId", FilterElementType.Equal, new Guid(creditCardId)) }).OfType<Mediachase.Commerce.Customers.CreditCard>()
                .FirstOrDefault();
        }
