            ...
            accessor.Principal.IsInRole("VisitorGroupAdmins"))
        {
            menuItems.Add("Visitor Groups",
                new QuickNavigatorMenuItem("/shell/cms/visitorgroups/index/name",
                    Paths.ToResource(typeof(ManageVisitorGroupsController).Assembly, "ManageVisitorGroups"), null,
                    "true", null));
        }
        ...
        /*if (accessor.Principal.IsInRole("CmsAdmins"))
        {
            menuItems.Add("Admin mode",
                new QuickNavigatorMenuItem("/shell/cms/menu/admin",
                    Paths.ToResource(typeof(ContentTypesController).Assembly, "default"), null, "true", null));
        }*/
